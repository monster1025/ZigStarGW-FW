...
def after_build(source, target, env):
    ...
    exit_code = call("python tools/merge_bin_esp.py --output_folder ./bin --output_name ZigStarGW.bin --bin_path bin/bootloader_dio_40m.bin bin/firmware.bin bin/partitions.bin --bin_address 0x1000 0x10000 0x8000", shell=True)
